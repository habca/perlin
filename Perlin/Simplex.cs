...
// Lisätty ohjelmaan Sebastian Laguen YouTube tutoriaalista: [Unity] Procedural Planets (E03: layered noise), https://www.youtube.com/watch?v=uY9PAcNMu8s
...
namespace Perlin
{
    public class Simplex
    {
        ...
        /// </summary>
        /// <param name="pos_x">x pos</param>
        /// <param name="pos_y">y pos</param>
        /// <param name="pos_z">z pos</param>
        /// <returns></returns>
        ...
        void Randomize(int seed)
        {
            ...
            for (int i = 0; i < 256; i++)
            {
                _random[256 + i] = _random[i] = Source[i]; 
            }
            */
